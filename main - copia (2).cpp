...
RECT size;
POINT pos;
bool R_Click,Power_Click=true,Alt,Ctrl,Shift,Alt2,Ctrl2,Shift2;
...
int GetKeyBoard(HWND window)
{
    ...
    while(true)
    {
        ...
        if(IsDlgButtonChecked(hwnd, ID_ALT2)!= BST_CHECKED){Alt2=true;}
        if(IsDlgButtonChecked(hwnd, ID_CTRL2)!= BST_CHECKED){Ctrl2=true;}
        if(IsDlgButtonChecked(hwnd, ID_SHIFT2)!= BST_CHECKED){Shift2=true;}
